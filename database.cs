...
private static DatabaseConnection? instance;
    ...
    private string connectionString = "Server=tcp:mathgame12.database.windows.net,1433;Initial Catalog=additiongame;Persist Security Info=False;User ID=student;Password=feDdw$31;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
   ...
   public async Task<List<string>> ExecuteQueryAsync(string query)
{
    ...
    internal async Task ExecuteQueryAsync<T>(string query)
    {
